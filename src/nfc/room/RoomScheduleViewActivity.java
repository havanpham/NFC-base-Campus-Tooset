...
// ///////////// Set first input data for list view//////////////////////////////////////////////////////
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View arg1,
				...
				String input_date = date.substring(0, 2) + ":"+ date.substring(2, 7) + ":"+date.substring(7);
			...
			case R.id.btn4:
				...
				for (int i = 0; i < thurs.size(); i++) {
					arrayAdapter.add(new ListItem(thurs.get(i).getName()
							...
							.getStartTime() + "-" + thurs.get(i).getEndTime(), thurs
							.get(i).getName()));
				}
				break;
			case R.id.btn5:
	...
	private void showDialog (final String date){
		...
		TextView item_take_note = (TextView)dialog.findViewById(R.id.Item_take_note);
		TextView item_note_manager = (TextView)dialog.findViewById(R.id.Item_note_manager);
		final RadioButton rbtn_take_note = (RadioButton)dialog.findViewById(R.id.rbtn_take_note);
		final RadioButton rbtn_note_manager = (RadioButton)dialog.findViewById(R.id.rbtn_note_manager);
		...
		OnClickListener checked_take_note = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(rbtn_note_manager.isChecked()) rbtn_note_manager.setChecked(false);
		...
		OnClickListener checked_note_manager = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(rbtn_take_note.isChecked()) rbtn_take_note.setChecked(false);
		...
		btn_ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				case NOTE_MANAGER:
					Intent i = new Intent(RoomScheduleViewActivity.this, WorkBusy.class);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case 0:
			...
			Intent i_menu = new Intent(RoomScheduleViewActivity.this, RoomMenuActivity.class);
			startActivity(i_menu);
			break;
		case 1:
			Intent i_manager  = new Intent(RoomScheduleViewActivity.this, RoomManagerActivity.class);
